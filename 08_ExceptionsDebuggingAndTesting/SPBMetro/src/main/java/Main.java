...
public class Main {
    ...
    private static final Marker INPUT_ERRS = MarkerManager.getMarker("INPUT_ERRS");
    ...
    public static void main(String[] args)
    {
        ...
        for(;;)
        {
            try {
                ...
                if (from.getName().equals("Девяткино")) {
                    throw new SpbException("Станция Девяткино вызывает ошибку!");
                } else if (from.getName().equals("Автово")) {
                    throw new SpbException("Станция Автово вызывает ошибку!");
                }
                logger.info("Пользователь ввел: {}.", from.getName());
                
                Station to = takeStation("Введите станцию назначения:");
                logger.info( "Пользователь ввел: {}.", to.getName());
